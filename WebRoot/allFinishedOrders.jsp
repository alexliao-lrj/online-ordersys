...
<title>All FINISHED ORDER</title>
<!--fonts-->
<link
...
<script type="text/javascript">
	function loadData(page) {
		//alert("succeed"+page);
		xmlAjaxRequest("showFinishedOrders?page=" + page + "&time="
	...
	function showData(responseXml, obj) {
		...
		for ( var i = 0; i < orders.length; i++) {
			...
			for ( var j = 0; j < child.length; j++) {
				...
				} else if (element.nodeName == "endtime"){
					endtime = element.childNodes[0].nodeValue;
				}
...
<body onload="loadData(1)">
	...
	<div class="menu">
		<div class="container">
			<div class="menu-info">
				...
				<h3>ALL FINISHED ORDERS HERE</h3>
	...
	<div id="cen">
		<ul id="pagination-clean">
			<li class="previous-off"><a id="pre">&lt;&lt;PREVIOUS</a></li>
