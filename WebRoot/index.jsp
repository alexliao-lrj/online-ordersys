	...
	<div class="welcome">
		<div class="container">
			<div class="wel-info">
				...
				<p>Welcome the summer's secrets reastaurant. Wish you a good
					dish！</p>
			</div>
				...
				<div class="col-md-4 welcome-grid">
					<div class="welcome-gd second">
						...
						<p>Weet-Bix, the breakfast cereal, was developed by Bennison
							...
							to make a product more palatable than "Granose," a biscuit </p>
					</div>
				</div>
				<div class="clearfix"></div>
			</div>
			...
			<div class="good-grids">
				...
				<div class="col-md-7 good-left">
					...
					<p>
						...
						a health education manual entitled Naturall a </span>Sweet
