...
<%
	FoodInfo info = (FoodInfo) request.getAttribute("food");
%>
...
<script type="text/javascript">
	function upload() {
		...
		tag.src = "foodpic/loading.gif";
		txtAjaxRequest("GetUploadFoodPicServlet?messageTitle=upload&time="
	...
	function showImg(responseTxt, obj) {
		...
		var tag = document.getElementById("imagetag");
		tag.src = "foodpic/" + responseTxt;
		document.getElementById("s").value = "foodpic/" + responseTxt;
...
<body onload="begin()">
	...
	<div class="menu">
		<div class="container">
			<div class="menu-info">
				<h3>PLEASE CHANGE FOOD</h3>
				<div class="strip-line"></div>
			</div>
			<div class="our-menu-grids">
				<div class="order-top">
					<li class="im-g"></li>
					<form method="post" action="processChangeFoodServlet">
						<li class="data">
							<h4>
								ID :<input type="hidden" name="id" value=<%=info.getId()%>>
							</h4>
							<h4>
								NAME : <input type="text" name="fname" value=<%=info.getName()%>>
							</h4>
							<h4>
								DESCRIBE : <input type="text" name="fdescription"
							...
							<h4>
								PRICE : <input type="text" name="fprice"
									value=<%=info.getPrice()%>>
							</h4>
							<h4>
								PICTURE : <input type="hidden" name="bpic" id='s'
									value=<%=info.getBpic()%>>
							</h4>
						</li>
						<li class="bt-nn">
					...
					<li><form target="targetFrame" enctype="multipart/form-data"
							method="post" action="uploadFoodPicServlet" name="imgform">
