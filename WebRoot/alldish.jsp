...
<body onload="begin()">
	...
	<div class="menu">
		<div class="container">
			...
			<div class="our-menu-grids">
				<%
					int npage = ((Integer) request.getAttribute("page")).intValue();
										    	ArrayList<FoodInfo> flist = (ArrayList<FoodInfo>)session.getAttribute("aflist");
										    	int count=0;
										    	if(flist != null){
				...
				<div class="order-top">
					...
					<li class="bt-nn">
						<form action="fdetail" method="post">
							<input type="hidden" name="number" value="<%=count%>"
								class="hvr-shutter-in-horizontal button">
							<h4><Button class="label label-danger" type="submit" name="button">EXPLORE</Button></h4>
	...
	<div id="cen">
		<ul id="pagination-clean">
			<li class="previous-off"><a href="alldish?page=<%=npage - 1%>">&lt;&lt;PREVIOUS</a>
			</li>
			<li class="next"><a href="calldish?page=<%=npage + 1%>">NEXT&gt;&gt;</a>
			</li>
		</ul>
	</div>
	<br>
	<div id="cen">
		<form action="addorder" method="post">
			<h4 class="data">PLEASE CONFIRM THE TABLE ID:</h4>
			<h4>
				<input type="text" name="ordertid">
				<Button class="label label-danger" type="submit" name="button">CONFIRM</Button>
			</h4>
		</form>
	</div>
	<br>
