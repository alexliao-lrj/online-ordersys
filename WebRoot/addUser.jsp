				...
				<div class="container">
					<div class="navigation text-center">
						...
						<ul class="nav1">
							...
							<li><a href="alldish">ALL DISHES</a></li>
				...
				<div class="order-top">
					...
					<form target="targetFrame" enctype="multipart/form-data"
						...
						<form method="post" action="addUserServlet">
								...
								<li><input type="text" name="account"></li></h4>
							
								<h4><li class="text-info">Password:</li>
								<li><input type="password" name="password"></li></h4>
							
								<h4><li class="text-info">Phone:</li>
								<li><input type="text" name="phone"></li></h4>
							
								<h4><li class="text-info">Salary:</li>
								<li><input type="text" name="salary"></li></h4>
							
								<h4><li class="text-info">Job</li>
