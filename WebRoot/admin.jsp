	...
	<div class="header" style="height:90px;">
		<div class="container" style="height:90px;">
			<div class="top-header" style="height:90px;">
				...
				<div
					style="position:relative; left:300px;top:-22px;width:300px;height:50px">
					<h4>
						...
						<div class="banner one">
							<div class="container">
								...
								<div class="banner-info text-center">
									<p>Welcome Our Administrator!!</p>
									<div class="order">
										<ul>
											<li><a href="adminIndexServlet?flag=1">MENU</a>
											</li>
											<li><a href="adminIndexServlet?flag=2">ORDER</a>
											</li>
											<li><a href="adminIndexServlet?flag=3">EMPLOYEE</a>
											</li>
									</div>
								</div>
							</div>
