...
/**
 * Servlet implementation class showFinishedOrders
 */
public class showFinishedOrders extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public showFinishedOrders() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	ArrayList<MyorderInfo> list = mapping.getAllFinishedOrder((page - 1) * 5, 10);
